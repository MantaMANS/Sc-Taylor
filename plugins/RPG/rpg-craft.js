    ...
    const sections = [{
        ...
        rows: [{
            ...
            },
            {
                title: "Robo 🤖",
                rowId: ".craft robo",
                description: "Crafting A Robo (but that's ilegal)"
            },
        ]
    }, ]
        ...
        if (/craft|Crafting/i.test(command)) {
            ...
            switch (type) {
                ...
                case 'robo':
                    ...
                    global.db.data.users[m.sender].emerald -= 6
                    global.db.data.users[m.sender].money -= 100000
                    global.db.data.users[m.sender].diamond -= 12
                    global.db.data.users[m.sender].robo += 1
                    global.db.data.users[m.sender].roboxp = 5
